...
//         {
//             var user = _authService.Register(registerDto.Name, registerDto.Email, registerDto.PasswordHash);
//             if (user == null)
...
//         public IActionResult Register([FromBody] RegisterDto registerDto)
//         {
//             var user = _authService.Register(registerDto.Name, registerDto.Email, registerDto.Password);
